...
function AiStates.Ravenhear:OnInit(brain)
	self.lastTimeHEAR = brain._currentTime
end

function AiStates.Ravenhear:Evaluate(brain)
...
function AiStates.RavenIdle:OnInit(brain)			-- dodac delay pomiedzy atakami
	local actor = brain._Objactor
	local aiParams = actor.AiParams
...
function AiStates.RavenIdle:OnUpdate(brain)
	local actor = brain._Objactor
	local aiParams = actor.AiParams
...
function AiStates.RavenIdle:Evaluate(brain)
	return 0.01
end
