...
--============================================================================
function MiniGunRL:FireSFX(pe,re)
    ...
    QuadSound(pe)
    if re then Templates["Rocket.CItem"]:AddFX(re) end
end
Network:RegisterMethod("MiniGunRL.FireSFX", NCallOn.ServerAndAllClients, NMode.Reliable, "ee")
--============================================================================
...
function MiniGunRL:HitTest()
    ...
    if b and e then
        ...
        if Game.GMode == GModes.SingleGame and ENTITY.IsWater(e) then
            Client_MiniGunRL_HitWaterSFX(x,y,z,nx,ny,nz,fv.X,fv.Y,fv.Z,e)
        else
...
function MiniGunRL:HitWallSFX(entity,x,y,z,nx,ny,nz,fx,fy,fz)
    ...
    if obj and obj.SoundHitByBullet and math.random(100) < 50 then
        local snd = obj.SoundHitByBullet[math.random(1,table.getn(obj.SoundHitByBullet))]
        PlaySound3D("impacts/"..snd,x,y,z,15,40)
    else
...
--============================================================================
function Client_MiniGunRL_HitWaterSFX(x,y,z,nx,ny,nz,fx,fy,fz,e)
