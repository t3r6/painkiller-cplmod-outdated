...
Tweak = 
{
    ...
    {
        JumpStrength = 2.5,
        AccelerationForward = 1.0,
        AccelerationBackward = 0.7,
        MaxSpeedForward = 30.0,
        MaxSpeedBackward = 10.0,
        BrakeSpeed = 2.0,
        SpeedFade = 0.01,
        MaxTurnSpeedStanding = 180.0,	-- degrees per second
        MaxTurnSpeedMaxRiding = 45.0,	-- degrees per second
        AirControlCoefficient0To1 = 0.5,
    },
