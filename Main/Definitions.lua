...
Actions = 
{
	...
	FireBestWeapon1		= 128*256,
    FireBestWeapon2		= 256*256,

    RocketJump			= 2*256*256,
    ForwardRocketJump	= 4*256*256,    
    UseCards			= 8*256*256,

    ComboFire			= 16*256*256,

    SelectBestWeapon1	= 32*256*256,
    SelectBestWeapon2	= 64*256*256,

	Weapon6				= 128*256*256,
    Weapon7				= 256*256*256,
    Weapon8				= 2*256*256*256,
    Weapon9				= 4*256*256*256,
    Weapon10			= 8*256*256*256,

    RotateLeft			= 16*256*256*256,
    RotateRight			= 32*256*256*256,
    MoveVector			= 64*256*256*256,
}
...
SoundsDefs = {
	cementary_stones = {
		samples = {"impacts/figure-stone-impact1","impacts/figure-stone-impact2"},
        dist1 = 15,
        dist2 = 60,
    },

    catacombs_stones = {
        samples = {"impacts/stonebig-impact1","impacts/stonebig-impact2","impacts/stonebig-impact3","impacts/stonebig-impact4"},
        dist1 = 20,
        dist2 = 80,
    },
    catacombs_column = {
    ...
    opera_trashcan = {
		samples = {"impacts/trashcan-impact1","impacts/trashcan-impact2","impacts/trashcan-impact3"},
        dist1 = 10,
        dist2 = 40,
    },
    opera_trashcancover = {
		samples = {"impacts/trashcancover-impact1","impacts/trashcancover-impact2","impacts/trashcancover-impact3"},
        dist1 = 10,
        dist2 = 40,
    },
    asylum_chair = {
		samples = {"impacts/pallet-impact1","impacts/pallet-impact2","impacts/pallet-impact3"},
        dist1 = 10,
        dist2 = 40,
    },
    asylum_bed = {
		samples = {"impacts/chest-wood-impact1","impacts/chest-wood-impact2","impacts/chest-wood-impact3"},
        dist1 = 15,
        dist2 = 40,
    },
    militaryb_tank = {
        samples = {"impacts/gasbotlle-impact1","impacts/gasbotlle-impact2","impacts/gasbotlle-impact3",},
        dist1 = 15,
        dist2 = 60,
    },
    heavymetal = {
	...
	woodfalls = {
		samples = {"impacts/wood-fallsdown1","impacts/wood-fallsdown2","impacts/wood-fallsdown3"},
        dist1 = 15,
        dist2 = 50,
	},
    boxmetal = {
		samples = {"impacts/box-metal-impact1","impacts/box-metal-impact2","impacts/box-metal-impact3"},
        dist1 = 15,
        dist2 = 40,
	},
...
SoundsProperties =
{
    {"default", 8, 0.05},		-- max. ilosc instancji, nie czesciej niz (sec.)
...
setmetatable(SoundsProperties,{__mode="k"}) 
...
--============================================================================
function ApplySoundsProperties()
