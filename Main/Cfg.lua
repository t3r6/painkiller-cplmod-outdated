...
Cfg = 
{
    ...
    ServerMapsPCF = {},
    ServerMapsVSH = {},
    ServerName = "Painkiller v1.35 + CPLMOD",
    ServerPassword = "",
    ServerPort = 3455,
    SfxVolume = 100,
    Shadows = 0,
...
HUD_AmmoList_Erasures = true,
HUD_AmmoList_Color_B = 100,
HUD_AmmoList_Color_G = 160,
HUD_AmmoList_Color_R = 255,
HUD_AmmoList_Digits_Calibrate_X = 0,
HUD_AmmoList_Digits_Calibrate_Y = 0,
HUD_AmmoList_Digits_ColorRed_B = 255,
HUD_AmmoList_Digits_ColorRed_G = 255,
HUD_AmmoList_Digits_ColorRed_R = 255,
HUD_AmmoList_Digits_Color_B = 255,
HUD_AmmoList_Digits_Color_G = 255,
HUD_AmmoList_Digits_Color_R = 255,
HUD_AmmoList_Digits_Transp = 255,
HUD_AmmoList_Icons_Scale = 1,
HUD_AmmoList_Icons_Transp = 255,
HUD_AmmoList_Pos = 1,
HUD_AmmoList_Pos_X = 0,
HUD_AmmoList_Pos_Y = 200,
HUD_AmmoList_Scale = 1,
HUD_AmmoList_Show = true,
HUD_Ammo_Show = false,

HUD_TeamScores_Box_Pos_X = 10,
HUD_TeamScores_Box_Pos_Y = 100,
HUD_TeamScores_Box_Show = false,
HUD_TeamScores_Box_Size_X = 150,
HUD_TeamScores_Box_Size_Y = 55,
HUD_TeamScores_Icons_Show = true,
HUD_TeamScores_Names_Show = false,
HUD_TeamScores_Show = true,
HUD_TeamScores_Team1_Color_B = 97,
HUD_TeamScores_Team1_Color_G = 161,
HUD_TeamScores_Team1_Color_R = 230,
HUD_TeamScores_Team1_Font_Size = 32,
HUD_TeamScores_Team1_Icon_Pos_X = 695,
HUD_TeamScores_Team1_Icon_Pos_Y = 675,
HUD_TeamScores_Team1_Icon_Scale = 1,
HUD_TeamScores_Team1_Name = "Team 1:",
HUD_TeamScores_Team1_Pos_X = 740,
HUD_TeamScores_Team1_Pos_Y = 680,
HUD_TeamScores_Team2_Color_B = 97,
HUD_TeamScores_Team2_Color_G = 161,
HUD_TeamScores_Team2_Color_R = 230,
HUD_TeamScores_Team2_Font_Size = 32,
HUD_TeamScores_Team2_Icon_Pos_X = 695,
HUD_TeamScores_Team2_Icon_Pos_Y = 725,
HUD_TeamScores_Team2_Icon_Scale = 1,
HUD_TeamScores_Team2_Name = "Team 2:",
HUD_TeamScores_Team2_Pos_X = 740,
HUD_TeamScores_Team2_Pos_Y = 730,

HUD_CurrentWeapon_Icon_Pos_Modif_X = 500,
HUD_CurrentWeapon_Icon_Pos_Modif_Y = 660,
HUD_CurrentWeapon_Icon = true,

ShowTimer = true,
ShowTimerCountUp = false,

HUD_FPS_Font_Size = 26,
HUD_FPS_Pos_X = 900,
HUD_FPS_Pos_Y = 10,
HUD_FPS_Show = true,
HUD_FPS_Text_Interval = -50,

HUD_Timer_Minutes_Pos_X = 915,
HUD_Timer_Minutes_Pos_Y = 50,
