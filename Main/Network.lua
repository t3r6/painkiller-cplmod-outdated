...
function Network:RegisterMethod(name,sendto,mode,args)
    ...
    for i,o in Network.SortedMethods do 
        if o[2] == name then
            MsgBox("Network method: '"..name.."' is already registered!!!")
            return
        end
    end
    ...
    for i,o in Network.SortedMethods do 
        Network.SortedMethods[i][1] = i 
        --EDITOR.OutputText(i.." - "..Network.SortedMethods[i][2])
    end
...
function SendNetMethod(event,clientID,singleClient,reliable,...)
    ...
    --    if event[2] ~= "Game.PlayerCamYaw" and event[2] ~= "Game.PlayerPingInfo" and event[2] ~= "CPlayer.SetupAction" then
    --        Game:Print("NET.MsgSend: "..msgnr.." : "..event[2])
    --    end
    --end
...
function GetNetEvent(msg,clientID)      
	...
	--	if event[2] ~= "Game.PlayerCamYaw" and event[2] ~= "Game.PlayerPingInfo" then
	--		Log("* GetNetEvent time: "..event[2].." "..a2-a1.." ms\n")
	--	end
end
--============================================================================
