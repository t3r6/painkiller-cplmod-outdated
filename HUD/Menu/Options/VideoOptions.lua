VideoOptions =
{
	...
	applyAction = "PainMenu:ApplySettings(true); PainMenu:ReloadWeaponsTextures(); PainMenu:SetShadowsQuality(); PainMenu:ApplyVideoSettings(); PMENU.SetItemVisibility('ApplyButton',false)",
