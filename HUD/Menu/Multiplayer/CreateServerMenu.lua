		...
		GeneralTab =
		{
			...
			items = 
			{
				...
				GameMode =
				{
					...
					option = "GameMode",
					values = { "Free For All", "Team Deathmatch", "Voosh", "The Light Bearer", "People Can Fly" },
					visible = { TXT.Menu.FreeForAll, TXT.Menu.TeamDeathmatch, TXT.Menu.Voosh, TXT.Menu.TheLightBearer, TXT.Menu.PeopleCanFly },
					x	 = -1,
					y	 = 280,
					action = "",
					align = MenuAlign.Left,
