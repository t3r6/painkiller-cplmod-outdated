...
function CWeapon:Update()
    self.ShotTimeOut = self.ShotTimeOut - 1 / Game.ReloadSpeedFactor
...
function MuzzleFlash:Render(delta)
    ...
    if self.TimeOut < 0 then 
        ...
        R3D.DrawSprite(x,y,z,FRand(0.6,0.6)*self.Size,FRand(0,6.28),Color:New(150,150,150,255):Compose(),"Items/"..math.random(1,3))
    end
end
--============================================================================
function CWeapon:MuzzleFlash(jointname,ox,oy,oz,size)
